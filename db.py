        ...
        video_id = upsert_video(
            conn,
            {
                ...
                "metadata": {
                    ...
                    "audio_download_urls": item.get("audio_download_urls") or [],
                    "audio_download_candidates": item.get("audio_download_candidates") or [],
                    "author_nickname": item.get("author_nickname"),
                    "author_sec_user_id": item.get("author_sec_user_id"),
                    "audio_download_error": item.get("audio_download_error"),
                    "download_note": item.get("download_note"),
